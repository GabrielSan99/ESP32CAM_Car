...
//extern int CHANNEL_A = 0;
//extern int dutycycle_A = 0;

//extern int CHANNEL_B = 1;
//extern int dutycycle_B = 0;

void WheelAct(int i1, int i2, int i3, int i4);
...
static esp_err_t index_handler(httpd_req_t *req){
 ...
 page += "<script>document.body.style.background = '#87CEFA'</script>";
 ...
 page += "<p align=center>";
 page += "<input type='range' value='255' min='0' max='255' step='1' id='get_A' oninput='Fetch_A()'> &emsp;";
 page += "<input type='range' value='255' min='0' max='255' step='1' id='get_B' oninput='Fetch_B()'>";
 page += "</p>";

 
 page += "<p align=center>";
 page += "<label id='put_A'>Dutycycle A: 255</label> &emsp;&emsp;";  
 page += "<label id='put_B'>Dutycycle B: 255</label>";
 page += "</p>";



 page += "<script>";
 page += "function Fetch_A() {";
  page += "var get = document.getElementById('get_A').value;";
  page += "document.getElementById('put_A').innerHTML = 'Dutycycle A: ' + get;}";
 
 page += "function Fetch_B() {";
  page += "var get = document.getElementById('get_B').value;";
  page += "document.getElementById('put_B').innerHTML = 'Dutycycle B: ' + get;}";
 page += "</script>";

 
/*##### test function and onchange
 page += "<input type='text' id='myInput' oninput='myFunction()'>";

 page += "<p id='demo'></p>";
 
 page += "<script>";
 page += "function myFunction() {";
  page += "var x = document.getElementById('get_A').value;";
  page += "document.getElementById('demo').innerHTML = x;}";
 page += "</script>";
*/
...
/*
static esp_err_t pwmright_handler(httpd_req_t *req){
    ledcWrite(CHANNEL_A, dutycycle_A);
    Serial.print("Dutycyle_A: ");
    Serial.println(dutycycle_A);
    httpd_resp_set_type(req, "text/html");
    return httpd_resp_send(req, "OK", 2);
}

static esp_err_t pwmleft_handler(httpd_req_t *req){
    ledcWrite(CHANNEL_B, dutycycle_B);
...
/*
    httpd_uri_t pwmright_uri = {
        .uri       = "/pwmright",
        .method    = HTTP_GET,
        .handler   = pwmright_handler,
        .user_ctx  = NULL
    };

    httpd_uri_t pwmleft_uri = {
        .uri       = "/pwmleft",
        .method    = HTTP_GET,
        .handler   = pwmleft_handler,
        .user_ctx  = NULL
    };
*/    
   ...
   httpd_uri_t stream_uri = {
    ...
    if (httpd_start(&camera_httpd, &config) == ESP_OK) {
        ...
        //httpd_register_uri_handler(camera_httpd, &pwmright_uri);
        //httpd_register_uri_handler(camera_httpd, &pwmleft_uri);

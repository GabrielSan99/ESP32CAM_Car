...
const char* ssid = "NET_2G_SANCHES";   //Enter SSID WIFI Name
const char* password = "sanches123";   //Enter WIFI Password
...
extern int dutyclye_A;

extern int CHANNEL_B = 1;
extern int dutycyle_B;
...
void setup() {
  ...
  pinMode(IN1, OUTPUT); //Left Backward
  pinMode(IN2, OUTPUT); //Left Forward
